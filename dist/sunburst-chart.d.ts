...
interface SunburstChartGenericInstance<ChainableInstance> {
...
type SunburstChartInstance = SunburstChartGenericInstance<SunburstChartInstance>;

declare function SunburstChart(configOptions?: ConfigOptions): SunburstChartInstance;

export { type ConfigOptions, type DataNode, type Node, type SunburstChartGenericInstance, type SunburstChartInstance, SunburstChart as default };
