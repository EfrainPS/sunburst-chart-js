...
export default Kapsule({
  ...
  update: function(state) {
    ...
    newSlice.selectAll('.text-contour')
      .style('stroke-width', `${state.fontStrokeWidth}px`);
    ...
    function angularTextFits(d) {
      return measureTextWidth(nameOf(d.data).toString(), state.fontSize, { strokeWidth: state.fontStrokeWidth }) < getAvailableLabelAngularSpace(d);
    }
    ...
    function radialTextFits(d) {
      ...
      return measureTextWidth(nameOf(d.data).toString(), state.fontSize, { strokeWidth: state.fontStrokeWidth }) < getAvailableLabelRadialSpace(d);
    }
